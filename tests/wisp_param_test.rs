...
fn test_wisp_param_decode_s32() {
    ...
    let output = instance
        .call_with_value("add-ten", &input, 0)
    ...
    let output = instance
        .call_with_value("double", &input, 0)
...
fn test_wisp_param_decode_s64() {
    ...
    let output = instance
        .call_with_value("add-hundred64", &input, 0)
...
fn test_wisp_param_decode_f32() {
    ...
    let output = instance
        .call_with_value("half-f32", &input, 0)
...
fn test_wisp_param_decode_f64() {
    ...
    let output = instance
        .call_with_value("square-f64", &input, 0)
...
fn test_wisp_param_decode_string() {
    ...
    let output = instance
        .call_with_value("get-string-len", &input, 0)
