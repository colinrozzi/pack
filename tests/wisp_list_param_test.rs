...
fn test_wisp_list_len() {
    ...
    let input = Value::List(vec![Value::S32(1), Value::S32(2), Value::S32(3)]);
    let output = instance
...
fn test_wisp_list_first() {
    ...
    let input = Value::List(vec![Value::S32(42), Value::S32(10), Value::S32(5)]);
    let output = instance
...
fn test_wisp_list_second() {
    ...
    let input = Value::List(vec![Value::S32(1), Value::S32(99), Value::S32(3)]);
    let output = instance
    ...
    let input = Value::List(vec![Value::S32(1)]);
    let output = instance
        .call_with_value("list-second", &input, 0)
...
fn test_wisp_sum_first_two() {
    ...
    let input = Value::List(vec![Value::S32(10), Value::S32(20), Value::S32(30)]);
    let output = instance
    ...
    let input = Value::List(vec![Value::S32(7)]);
    let output = instance
        .call_with_value("sum-first-two", &input, 0)
